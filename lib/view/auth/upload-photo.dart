          ...
          children: [
            Column(
              children: [
                ...
                Text(
                  "Update your photo to earn rewards",
                  style: TextStyle(
                ...
                Text(
                  "To earn rewards from coinbase, you need to upload your photo. This is different from account verification "
              ...
              children: [
                ElevatedButton(
                  ...
                  child: Text(
                    "Continue",
                    style:
                        TextStyle(fontFamily: "GraphikMedium", fontSize: 16.0),
                  ),
                  style: ButtonStyle(
